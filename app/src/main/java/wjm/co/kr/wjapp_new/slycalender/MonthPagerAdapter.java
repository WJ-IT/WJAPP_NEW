...
import wjm.co.kr.wjapp_new.slycalender.listeners.GridChangeListener;
...
public class MonthPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        ((TextView) view.findViewById(R.id.txtSelectedMonth)).setText(new SimpleDateFormat("yyyy LLLL", Locale.getDefault()).format(currentDate.getTime()));
